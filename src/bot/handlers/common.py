...
async def cmd_start(message: Message, session: AsyncSession) -> None:
    ...
    await message.answer(
        ...
        "• кофе 200 динар · зарплата 180000\n"
        "• доход 50000 рублей\n"
...
async def cmd_help(message: Message) -> None:
    await message.answer(
        ...
        "*Расходы:*\n"
        "• кофе 200 динар · продукты 3500\n\n"
        "*Доходы:*\n"
        "Напиши текстом с суммой и словом «зарплата», «доход» или «получил»:\n"
        "• зарплата 180000\n"
        "• доход 50000 рублей\n"
        "• получил 300 евро\n"
        "Бот предложит счёт для зачисления.\n\n"
